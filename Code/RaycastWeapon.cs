...
public class RaycastWeapon : MonoBehaviour
{
    ...
    public Weapon_Recoil _Recoil;
    public GameObject Full_mag;


    private void Awake()
    {
        _Recoil = GetComponent<Weapon_Recoil>();
    ...
    private void RaycastSegment(Vector3 start, Vector3 end , bullet Bullet)
    {
        ...
        if (Physics.Raycast(Ray, out HitInfo, distance, layerMask))
        {
            ...
            zombieHitBox = HitInfo.collider.GetComponent<ZombieHitBox>();
            if(zombieHitBox)
            {
                zombieHitBox.OnRayCastHit(this, Ray.direction);
            }
    ...
    private void FireBullet(Vector3 target) // Bullet With Physic
    {
        ...
        Bullets.Add(Bullet);
        _Recoil.Genarate_Recoil(Weapon_Name);
    }
